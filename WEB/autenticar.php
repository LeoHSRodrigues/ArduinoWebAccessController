...
$serial->deviceSet("/dev/ttyACM0");
    ...
    // If you want to change the configuration, the device must be closed.
        ...
        $resultado = $banco->seleciona('nome,status,sigla,cargo,U.CPF','usuario as u inner join setorusuario as su on u.CPF = su.CPF inner join setor as s on s.idSetor = su.idSetor','where u.TAGRFID = "'.$valor.'" and computadorResponsavel = "'.$nomeComputador.'"');
        $teste = $resultado->rowCount();
        if ($teste === 1){
